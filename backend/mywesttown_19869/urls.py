"""mywesttown_19869 URL Configuration
...
admin.site.site_header = "MyWesttown"
admin.site.site_title = "MyWesttown Admin Portal"
admin.site.index_title = "MyWesttown Admin"

# swagger
api_info = openapi.Info(
    title="MyWesttown API",
    default_version="v1",
    description="API documentation for MyWesttown App",
)
